...
syn keyword clayKeyword public private import record variant instance procedure overload external alias callbyname inline enum var if else goto return while switch break continue for try catch throw define as extend with
